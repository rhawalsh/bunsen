DOCUMENTATION = """
  lookup: released_repo_roots
  author: Joe Shimkus <jshimkus@redhat.com>
  version_added: "0.1"
  short_description: return uris for released distribution/architecture
                      pairings
  description:
    - This lookup returns the released uris for specified
...
class LookupModule(LookupBase):
  def run(self, _terms, variables = None, **kwargs):
      ...
      return [Distribution.makeItem(distribution,
